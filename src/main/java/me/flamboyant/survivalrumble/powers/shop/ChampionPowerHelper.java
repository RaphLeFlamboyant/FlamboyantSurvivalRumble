...
public class ChampionPowerHelper {
    public static List<ChampionPowerShopItem> buildChampionPowerList() {
        return Arrays.asList(
                ...
                new ChampionPowerShopItem(ChampionPowerType.EFFECT_SATURATION, Arrays.asList(new LevelDescription(100, new ArrayList<>(Arrays.asList("Effet Saturation")))), "Saturation", Material.COOKED_BEEF),

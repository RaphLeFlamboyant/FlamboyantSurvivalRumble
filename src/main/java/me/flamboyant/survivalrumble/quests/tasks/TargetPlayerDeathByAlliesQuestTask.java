...
public class TargetPlayerDeathByAlliesQuestTask extends TargetPlayerDeathQuestTask {
    public TargetPlayerDeathByAlliesQuestTask(Quest ownerQuest, Player playerToDie, int quantity) {

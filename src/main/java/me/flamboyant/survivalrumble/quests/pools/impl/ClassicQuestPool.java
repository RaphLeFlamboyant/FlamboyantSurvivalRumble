...
public class ClassicQuestPool extends AQuestPoolBase {
    ...
    protected void buildQuestList() {
        ...
        Quest quest = new Quest("Les basses besognes", 250, 0);
        ...
        quest = new Quest("Préparer la mousson", 150, 0);
        ...
        questTasks = new ArrayList<>();
        quest = new Quest("Exil en enfer", 2500, 0);
        ...
        questTasks = new ArrayList<>();
        quest = new Quest("Décorer les environs", 150, 0);

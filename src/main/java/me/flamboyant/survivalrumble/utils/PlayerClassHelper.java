...
public class PlayerClassHelper {
    public static Map<PlayerClassType, PlayerClassMetadata> playerClassMetadata = new HashMap<PlayerClassType, PlayerClassMetadata>() {{
        ...
        put(PlayerClassType.SCOUT, new PlayerClassMetadata(PlayerClassType.SCOUT, PlayerClassCategory.OFFENSIVE_ENVIRONMENT, Material.TORCH, "ÉCLAIREUR", Sound.BLOCK_GRASS_STEP, "Éclaireur", "connait votre base par coeur"));
        ...
        put(PlayerClassType.MASON, new PlayerClassMetadata(PlayerClassType.MASON, PlayerClassCategory.BLOC_SCORING, Material.BRICK, "MAçON", Sound.BLOCK_NETHER_BRICKS_BREAK, "Maçon", "Une défaite pavée de briques"));
        put(PlayerClassType.BUNGLER, new PlayerClassMetadata(PlayerClassType.BUNGLER, PlayerClassCategory.BLOC_SCORING, Material.STONE_PICKAXE, "SABOTEUR", Sound.BLOCK_GLASS_BREAK, "Saboteur", "Votre base sera un gruyère"));
        put(PlayerClassType.PYROMANIAC, new PlayerClassMetadata(PlayerClassType.PYROMANIAC, PlayerClassCategory.OFFENSIVE_ENVIRONMENT, Material.BLAZE_POWDER, "PYROMANE", Sound.BLOCK_PISTON_EXTEND, "Pyromane", "va vous réduire en cendres"));
        put(PlayerClassType.TRAPPER, new PlayerClassMetadata(PlayerClassType.TRAPPER, PlayerClassCategory.OFFENSIVE_ENVIRONMENT, Material.SPRUCE_TRAPDOOR, "TRAPPEUR", Sound.BLOCK_IRON_TRAPDOOR_OPEN, "Trappeur", "Bouger c'est mourir"));
        ...
        put(PlayerClassType.ELBMURLAVIVRUS, new PlayerClassMetadata(PlayerClassType.ELBMURLAVIVRUS, PlayerClassCategory.BLOC_SCORING, Material.BAKED_POTATO, "ELBMUR LAVIVRUS", Sound.ENTITY_VILLAGER_CELEBRATE, "Elbmur Lavivrus", "A déjà vaincu le jeu"));
        put(PlayerClassType.PEASANT, new PlayerClassMetadata(PlayerClassType.PEASANT, PlayerClassCategory.BLOC_SCORING, Material.HAY_BLOCK, "PAYSAN", Sound.BLOCK_GRASS_BREAK, "Paysan", "Il cultive sa victoire"));
        ...
        put(PlayerClassType.BOORISH, new PlayerClassMetadata(PlayerClassType.BOORISH, PlayerClassCategory.BLOC_SCORING, Material.COAL_ORE, "RUSTRE", Sound.ENTITY_PILLAGER_AMBIENT, "Rustre", "Il vit dans une grotte"));

...
public class PlayerClassHelper {
    public static Map<PlayerClassType, PlayerClassMetadata> playerClassMetadata = new HashMap<>() {{
        ...
        put(PlayerClassType.TRAPPER, new PlayerClassMetadata(PlayerClassType.TRAPPER, PlayerClassCategory.ATTACK, Material.SPRUCE_TRAPDOOR, "TRAPPEUR", Sound.BLOCK_IRON_TRAPDOOR_OPEN, "Trappeur", "Bouger c'est mourir"));
